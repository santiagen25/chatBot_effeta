...
client.on('message_create', async (msg) => {
    ...
    if (msg.body === '!calcula' || msg.body === '!calculame' || msg.body === '!records' || msg.body.startsWith('!calculale') || msg.body.startsWith('!calculadesde') || msg.body === '!calcula cat') {
        ...
        msg.reply("!calcula: Coge todos los mensajes y recuenta los emoticonos de cada uno.\n\n"+
                    ...
                    "!info u !hola: Información del ChatBot-Effeta.\n\n"+
        ...
        msg.reply("¡Hola! Soy ChatBot-Effeta, y estoy programado para contar de forma automática los emoticonos del grupo de oración.\n"+
                    "Por favor, para facilitarme el trabajo sigue las siguientes indicaciones:\n\n"+
                    ...
                    "No escribas decimales, pues tampoco los entiendo bien...\n\t_Si me escribes:_\n\t🙏3,5\n\t_Creere que has realizado solo 3 oraciones en lugar de 3,5._\n\n"+
